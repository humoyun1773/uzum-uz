...
export const TopBar: React.FC = () => {
  ...
  return (
    <div className="bg-[#F2F4F7] border-b border-gray-200 text-xs text-gray-600 py-1.5 hidden sm:block relative z-[100]">
      <div className="max-w-[1280px] mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative z-[100]" ref={langRef}>
            <button 
            ...
            {isLangDropdownOpen && (
              <div className="absolute right-0 top-full mt-1.5 bg-white rounded-xl shadow-2xl border border-gray-200 py-1.5 w-40 z-[100] animate-fade">
